...
namespace GridDemo
{
    public class DataGenerator
    {
        ...
        {
            Array values = EnumHelper.GetValues(enumType);
        ...
        public static List<string> ExtractTitles()
        {
            ...
            IList employees = NWindData.Employees;
            foreach (Employees row in employees)
            {
                if (!titles.Contains(row.Title))
        ...
        public static List<string> ExtractEmployers()
        {
            ...
            foreach (Customers row in customers)
            {
                if (!employers.Contains(row.CompanyName))
                    employers.Add(row.CompanyName);
            }
            return employers;
        }
        public static List<Tuple<string, string>> ExtractAddressAndCity()
        {
            ...
            foreach (Customers row in customers)
            {
                Tuple<string, string> addr = new Tuple<string, string>(row.Address, row.City);
