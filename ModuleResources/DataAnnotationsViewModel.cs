...
namespace GridDemo
{
    public class DataAnnotationsViewModel
    {
        const int RowCount = 100;
        Random rnd = new Random();
        protected DataAnnotationsViewModel()
        {
        ...
        IEnumerable<MaskedInputData> GetMaskedInputData()
        {
            ...
            for (int i = 0; i < RowCount; i++)
            {
                ...
                {
                    PercentProperty = rnd.NextDouble(),
                    CurrencyProperty = rnd.Next(1, 20) * 100 - 0.1m,
                    NumberProperty = rnd.Next(10000000) / 100d,
                    FixedPointProperty = rnd.Next(10000000) / 100d,
                    Decimal4DigitsProperty = rnd.Next(10000),
                    CustomNumericMaskPropery1 = rnd.Next(100000) / 10d,
                    CustomNumericMaskPropery2 = rnd.Next(100000) / 10d,
